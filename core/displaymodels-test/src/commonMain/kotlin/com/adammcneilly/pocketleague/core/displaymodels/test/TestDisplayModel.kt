...
//        ),
    ...
    val matchDetailOrangeWinner =
        matchDetailBlueWinner.copy(
            orangeTeamResult = matchTeamResultWinner,
            blueTeamResult = matchTeamResultLoser,
        )

    val gameTeamResultWinner =
    ...
    val gameDetailOrangeWinner =
        gameDetailBlueWinner.copy(
            orangeTeamResult = gameTeamResultWinner,
            blueTeamResult = gameTeamResultLoser,
        )

    val eventStageSummary =
