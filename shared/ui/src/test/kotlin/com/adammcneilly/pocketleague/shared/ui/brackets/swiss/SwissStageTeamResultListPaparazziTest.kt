...
import com.adammcneilly.pocketleague.core.displaymodels.test.fallMajorList
...
class SwissStageTeamResultListPaparazziTest {
    ...
    fun render() {
        paparazzi.snapshotScreen(
            ...
            SwissStageTeamResultList(
                teamResults = SwissStageTeamResultDisplayModel.fallMajorList(),
            )
        }
    }
}
